...
export class PersonalPage {
  ...
  constructor(private evts: Events, private nav: NavController, private us: UserService,  private menu: MenuController, private modalCtrl:ModalController) {
    this.getUserData();
  }
  getUserData(){
    console.log("arrivo");
  ...
  userData(){
    ...
    let modal = this.modalCtrl.create(UserDataPage, {user: this.user});
    modal.present();
  }
