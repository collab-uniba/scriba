...
export class EventPage {
  ...
  constructor(private nav: NavController, private np: NavParams, private es: EventService, private evts: Events, private modalCtrl:ModalController, private alertCtrl:AlertController) {
  ...
  newSession(){
    ...
    let modal = this.modalCtrl.create(NewSessionPage, {event: this.event, sessions: this.sessions});
    modal.present();
  }
