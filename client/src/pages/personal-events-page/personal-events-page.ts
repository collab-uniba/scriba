...
@Component({
  templateUrl: 'personal-events-page.html',
...
export class PersonalEventsPage {
  ...
  constructor(private evts: Events, private nav: NavController, private es: EventService, private modalCtrl: ModalController, private alertCtrl:AlertController) {
