...
export class SessionPage {
  ...
  constructor(private nav: NavController, private np: NavParams, private es: EventService, private evts: Events, private alertCtrl: AlertController, private modalCtrl: ModalController) {
    //this.session
  ...
  newIntervent(){
    ...
    let modal = this.modalCtrl.create(NewInterventPage, {session: this.session, intervents: this.intervents});
    modal.present();
  }
