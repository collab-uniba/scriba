...
export class HomePage {
  ...
  private tu;
  constructor(private evts: Events, private nav: NavController, private es: EventService, private us: UserService, private alertCtrl:AlertController, private modalCtrl:ModalController) {
    this.updateEvents();
