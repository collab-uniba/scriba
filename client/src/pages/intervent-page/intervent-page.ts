...
export class InterventPage {
    ...
    private room = null;  
    constructor(private es: EventService, private evts: Events, private np: NavParams, private nav: NavController, private ts: TranscriptionService, private alertCtrl:AlertController) {
        this.transcription="";
        //this.intervent.text="";
